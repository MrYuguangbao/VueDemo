        ...
        <div id="title">
            <el-row>
                <el-col :offset="6" :span="12">
                    <h1 style="color:#00A6FF">数据检索可视化</h1>
                </el-col>
            </el-row>
        </div>
        <el-row>
            <el-col :span="6">
                    <el-row>
                        <el-col :span="24">
                            <el-card  :style="left">
                                <div id="left" style="width:100%;height:400px">
                                </div>
                            </el-card>
                        </el-col>
                    </el-row>
            ...
            <el-col :span="12" >
                <el-card :style="middle">
                    <div id="middle" style="width:100%;height:500px">
                    </div>
                </el-card>
            </el-col>
            <el-col :span="6">
                    <el-row>
                        <el-col :span="24">
                            <el-card   :style="right">
                                <div id="right" style="width:100%;height:400px">
                                </div>
                            </el-card>
                        </el-col>
                    </el-row>
...
export default {
  ...
  methods: {
    renderMap () {
      let myChart = echarts.init(document.getElementById('middle'))
      let option = {
